...
namespace UI {
    TetrisConfig::TetrisConfig(bool& show)
        : showTetrisConfig(show)
    {}
    ...
    void TetrisConfig::Show() {
        ...
        if (showTetrisConfig) {
            ...
            ImGui::Begin("asda", &showTetrisConfig, ImGuiWindowFlags_HorizontalScrollbar | ImGuiWindowFlags_NoResize |
            ...
            ImGui::Button("back");
            if (ImGui::IsItemClicked()) this->showTetrisConfig = false;
            ImGui::SameLine();
            ImGui::Button("save");
